  ...
  return (
    <>
      ...
      >
        ...
        <Link to="/login"><h2 className="flex text-sm gap-2 font-bold text-[#ff784e] "><FaUserCircle size={20}/>My Account</h2></Link>
          <button onClick={() => setIsOpen(false)}>
            <HiXMark size={24} />
          </button>
        </div>
        <h2 className="text-2xl gap-2 font-bold bg-[#ff784e] text-white p-4">Subcription Box</h2>
